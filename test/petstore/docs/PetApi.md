...
# **addPet**
> addPet(_api::PetApi, in_Pet; _mediaType=nothing) <br/>
> addPet(_api::PetApi, response_stream::Channel, in_Pet; _mediaType=nothing)
...
# **updatePet**
> updatePet(_api::PetApi, in_Pet; _mediaType=nothing) <br/>
> updatePet(_api::PetApi, response_stream::Channel, in_Pet; _mediaType=nothing)
