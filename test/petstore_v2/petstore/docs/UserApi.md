...
# **createUser**
> createUser(_api::UserApi, in_body; _mediaType=nothing) <br/>
> createUser(_api::UserApi, response_stream::Channel, in_body; _mediaType=nothing)
...
> createUsersWithArrayInput(_api::UserApi, in_body; _mediaType=nothing) <br/>
> createUsersWithArrayInput(_api::UserApi, response_stream::Channel, in_body; _mediaType=nothing)
...
> createUsersWithListInput(_api::UserApi, in_body; _mediaType=nothing) <br/>
> createUsersWithListInput(_api::UserApi, response_stream::Channel, in_body; _mediaType=nothing)
...
# **updateUser**
> updateUser(_api::UserApi, in_username::String, in_body; _mediaType=nothing) <br/>
> updateUser(_api::UserApi, response_stream::Channel, in_username::String, in_body; _mediaType=nothing)
